...
/*#__PURE__*/
function (_CustomEvent) {
  _inherits(Gamepad, _CustomEvent);
  ...
  function Gamepad() {
    ...
    $.on(window, 'gamepadconnected', function () {
      ...
      if (!_this._rafId) {
        _this._rafId = window.requestAnimationFrame(_this.checkButtons.bind(_assertThisInitialized(_assertThisInitialized(_this))));
      }
...
function () {
  function GamepadNotice() {
    _classCallCheck(this, GamepadNotice);
...
function () {
  function FieldCursor(data) {
    _classCallCheck(this, FieldCursor);
...
/*#__PURE__*/
function (_CustomEvent) {
  _inherits(EmptyComponent, _CustomEvent);

  function EmptyComponent() {
    _classCallCheck(this, EmptyComponent);

    return _possibleConstructorReturn(this, _getPrototypeOf(EmptyComponent).call(this));
  }
...
var MultiplayerPage = {
  ...
  init: function init() {
    ...
    this._fieldOne = new Field({
      ...
      userPanel: new UserPanel(fieldOneElem, {
        num: 1
      })
    });
    ...
    this._fieldTwo = new Field({
      ...
      userPanel: new UserPanel(fieldTwoElem, {
        num: 2
      })
    });
    this._onKeydown = this._onKeydown.bind(this);
